...
static ERL_NIF_TERM module_new(ErlNifEnv* env, int argc,
  ...
  LLVMModuleRef myModule = LLVMModuleCreateWithNameInContext(name, ctx);
...
static ErlNifFunc nif_funcs[] = 
  { 
    { "module_new", 1, module_new }, {
      "module_getFunction", 2, module_getFunction }, 
    { "module_dump", 1, module_dump } 
  };
